...
import com.example.lessonviewpager.adapter.ProductPagerAdapter
import com.example.lessonviewpager.databinding.FragmentProductBinding
...
class ProductFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = ProductPagerAdapter(requireActivity(),list)
